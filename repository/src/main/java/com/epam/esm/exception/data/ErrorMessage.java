...
public class ErrorMessage {
    ...
    public static final String ERROR_000007 = "tag with with such id is not exist";
    public static final String ERROR_000008 = "tag with with such name is not exist";

    public static final String ERROR_000020 = "certificate with such id is not exist";
