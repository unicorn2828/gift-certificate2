...
public class TagRepositoryData {
    ...
    public static final String SQL_FIND_ALL_TAGS = "SELECT id, tag_name FROM tag ORDER BY id";
    public static final String SQL_FIND_TAG_BY_ID = "SELECT id, tag_name FROM tag WHERE id = ?";
    ...
    public static final String SQL_TAG_NAME_FUNCTION = "SELECT id, tag_name FROM searchName3(:tag_name)";
